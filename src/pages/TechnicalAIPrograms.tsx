      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-20 mt-20">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-ai-purple/10 to-ai-blue/10 px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-sm font-medium text-ai-purple">Professional AI Training</span>
          </div>
        ...
        <section className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Our Most Popular Programs</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Comprehensive AI training programs designed for different technical roles and expertise levels
            </p>
          </div>
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
            {programs.map((program) => (
              <Card key={program.sno} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border bg-gradient-to-br from-background via-background to-ai-blue/5">
                <CardHeader className="pb-4">
                  <div className="flex items-start justify-between mb-3">
                    <Badge variant="secondary" className="bg-ai-purple/10 text-ai-purple hover:bg-ai-purple/20">
        ...
        <section className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Experience the difference with our research-backed, hands-on approach to AI education
            </p>
          </div>
              ...
              >
                <CardContent className="p-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-muted-foreground leading-relaxed flex-1">{usp}</p>
                  </div>
                </CardContent>
              </Card>
            ))}
