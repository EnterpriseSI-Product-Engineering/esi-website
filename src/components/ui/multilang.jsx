...
function Card(card) {
  ...
  return (
    <motion.div
      ...
      animate={controls}
      className={cn(
        "size-12 flex items-center justify-center cursor-pointer overflow-hidden rounded-xl border p-2",
      ...
      <div className="container mx-auto px-4 md:px-8 overflow-hidden">
        <div className="flex w-full flex-col items-center justify-center overflow-hidden">
          <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
            <Marquee
              reverse
              className="w-full overflow-hidden -delay-[200ms] [--duration:10s]"
              repeat={5}
            >
            ...
            <Marquee
              reverse
              className="[--duration:25s] w-full overflow-hidden"
              repeat={5}
            >
            ...
            <Marquee
              reverse
              className="-delay-[200ms] [--duration:20s] w-full overflow-hidden"
              repeat={5}
            >
              {randomTiles1.map((review, idx) => (
                <Card key={idx} {...review} />
