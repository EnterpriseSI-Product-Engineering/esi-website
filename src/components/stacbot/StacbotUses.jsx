...
import { VSCodeLogo, IMGS } from "@/assets";
const StacbotUses = () => {
  return (
    <div className="grid grid-cols-2 container mx-auto py-40 max-w-5xl">
      <div>
      ...
      <div className="border  rounded-xl grid place-items-center bg-white">
        <img src={IMGS.STACBOT_GIF} alt="" className="mt-15" />
      </div>
    </div>
  );
};

export default StacbotUses;
  ...
  jupyter: () => (
    ...
    >
      ...
      <g id="Canvas" transform="translate(-1640 -2453)" figma:type="canvas">
        <g id="Group" style={{ mixBlendMode: "normal" }} figma:type="group">
          <g id="Group" style={{ mixBlendMode: "normal" }} figma:type="group">
            <g id="Group" style={{ mixBlendMode: "normal" }} figma:type="group">
              <g id="g" style={{ mixBlendMode: "normal" }} figma:type="group">
                <g
                  id="path"
